...
description: "The agent is a separate worker process that handles AI-powered chat interactions. When you send a message in a thread, this worker picks up the task, runs the AI agent, streams output back to your ..."
---
