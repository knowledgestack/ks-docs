---
title: "Authorization"
description: "Knowledge Stack uses a two-tier authorization model: **roles** determine what a user can do, and **path permissions** determine where they can do it."
---
